...
export default class App extends React.Component {
  ...
  //Ik zou de opmaak van afbeeldingen voor de overzichtelijkheid in app.css doen.
  //In regel 67 zou ik voor de volledigheid ook Name: toevoegen. Hetzelfde geldt voor regel 69 em 71.
  render() {
    return (
      <div className="nav">
        <ul>
